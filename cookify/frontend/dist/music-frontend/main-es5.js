(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(router, fservice) {
                    this.router = router;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DashboardComponent = /** @class */ (function () {
                function DashboardComponent(fservice, route, router) {
                    this.fservice = fservice;
                    this.route = route;
                    this.router = router;
                    this.user = [];
                ...
                DashboardComponent.prototype.ngOnInit = function () {
                    ...
                    this.fservice.getUserDetails(this.username).subscribe(function (data) {
                        _this.user = data;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var DashboardrecipecardComponent = /** @class */ (function () {
                function DashboardrecipecardComponent(router) {
                    this.router = router;
                }
                DashboardrecipecardComponent.prototype.ngOnInit = function () {
                };
                DashboardrecipecardComponent.prototype.tr = function (id) {
                    this.router.navigateByUrl("/recipedetails/" + id);
                };
                return DashboardrecipecardComponent;
            }());
            DashboardrecipecardComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _frontendservice_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../frontendservice.service */ "./src/app/frontendservice.service.ts");
            var DashboardtrendingComponent = /** @class */ (function () {
                function DashboardtrendingComponent(http, fservice) {
                    this.http = http;
                    this.fservice = fservice;
                    this.recipe = [];
                    this.image = "https://media.gettyimages.com/photos/authentic-indian-food-picture-id639389404?s=612x612";
                }
                DashboardtrendingComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.fservice.getalltrendingrecipe().subscribe(function (data) { _this.recipe = data; console.log(_this.recipe, "data of trending recipe"); });
                };
                return DashboardtrendingComponent;
            }());
            DashboardtrendingComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FileUploadProfileComponent = /** @class */ (function () {
                function FileUploadProfileComponent(_http) {
                    this._http = _http;
                    /** Link text */
                    this.text = 'Upload';
                ...
                FileUploadProfileComponent.prototype.ngOnInit = function () {
                };
                FileUploadProfileComponent.prototype.onClick = function () {
                    var _this = this;
                    var fileUpload = document.getElementById('fileUpload');
                    fileUpload.onchange = function () {
                        for (var index = 0; index < fileUpload.files.length; index++) {
                            var file = fileUpload.files[index];
                            _this.files.push({ data: file, state: 'in',
                ...
                FileUploadProfileComponent.prototype.cancelFile = function (file) {
                    file.sub.unsubscribe();
                    this.removeFileFromArray(file);
                };
                FileUploadProfileComponent.prototype.retryFile = function (file) {
                    this.uploadFile(file);
                    file.canRetry = false;
                };
                FileUploadProfileComponent.prototype.uploadFile = function (file) {
                    var _this = this;
                    var fd = new FormData();
                    fd.append(this.param, file.data);
                    var req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpRequest"]('POST', this.target, fd, {
                        reportProgress: true,
                        responseType: "text"
                    });
                    file.inProgress = true;
                    file.sub = this._http.request(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (event) {
                        switch (event.type) {
                    ...
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function (message) { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["last"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(function (error) {
                        file.inProgress = true;
                        file.canRetry = true;
                        console.log(error);
                ...
                FileUploadProfileComponent.prototype.uploadFiles = function () {
                    var _this = this;
                    var fileUpload = document.getElementById('fileUpload');
                    fileUpload.value = '';
                ...
                FileUploadProfileComponent.prototype.removeFileFromArray = function (file) {
                    var index = this.files.indexOf(file);
                    if (index > -1) {
                        this.files.splice(index, 1);
                    }
                };
                FileUploadProfileComponent.prototype.approve = function (file) {
                };
                return FileUploadProfileComponent;
            }());
            FileUploadProfileComponent.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FileUploadComponent = /** @class */ (function () {
                function FileUploadComponent(_http) {
                    this._http = _http;
                    /** Link text */
                    this.text = 'Upload';
                    /** Name used in form which will be sent in HTTP request. */
                ...
                FileUploadComponent.prototype.cancelFile = function (file) {
                    file.sub.unsubscribe();
                    this.removeFileFromArray(file);
                    this.cancel.emit();
                };
                FileUploadComponent.prototype.retryFile = function (file) {
                    this.uploadFile(file);
                    file.canRetry = false;
                };
                FileUploadComponent.prototype.uploadFile = function (file) {
                    ...
                    var fd = new FormData();
                    fd.append(this.param, file.data);
                    var req = new _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpRequest"]('POST', this.target, fd, {
                        reportProgress: true,
                        responseType: "text"
                    });
                    file.inProgress = true;
                    file.sub = this._http.request(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (event) {
                        switch (event.type) {
                    ...
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (message) { }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["last"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["catchError"])(function (error) {
                ...
                FileUploadComponent.prototype.removeFileFromArray = function (file) {
                    var index = this.files.indexOf(file);
                    if (index > -1) {
                        this.files.splice(index, 1);
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm2015/index.js");
            var FrontendserviceService = /** @class */ (function () {
                function FrontendserviceService(http) {
                    this.http = http;
                ...
                FrontendserviceService.prototype.getalltopmasters = function () {
                    return this.http.get("http://localhost:3000/master");
                };
                FrontendserviceService.prototype.getalltrendingrecipe = function () {
                ...
                FrontendserviceService.prototype.getallrecommendedbyhistoryrecipe = function () {
                    var httpOptions = this.makeToken('token');
                ...
                FrontendserviceService.prototype.getallrecommendedrecipe = function () {
                    var httpOptions = this.makeToken('token');
                    var username = localStorage.getItem('username');
                ...
                FrontendserviceService.prototype.getallrecommendedrecipeByIngredients = function (list) {
                    var httpOptions = this.makeToken('token');
                    var username = localStorage.getItem('username');
                    return this.http.get("https://cookify.stackroute.io:8443/recommendationService/api/v1/recipes/" + list, httpOptions);
                };
                FrontendserviceService.prototype.userRegister = function (user) {
                    var url = "https://cookify.stackroute.io:8443/userLogin/register";
                    return this.http.post(url, user);
                };
                FrontendserviceService.prototype.login = function (user) {
                    var _url = "https://cookify.stackroute.io:8443/userLogin/authenticate";
                    return this.http.post(_url, user, { observe: 'response' });
                };
                FrontendserviceService.prototype.logout = function () {
                    localStorage.removeItem('username');
                    localStorage.removeItem('token');
                    localStorage.removeItem('name');
                };
                //get user by id in selectinterest
                FrontendserviceService.prototype.getUser = function (id) {
                    var url = "https://cookify.stackroute.io:8443/userLogin/user/" + id;
                    return this.http.get(url);
                };
                FrontendserviceService.prototype.getStateAndCountry = function () {
                ...
                //   }
                FrontendserviceService.prototype.submitfinalfavourites = function (obj) {
                    console.log(obj.cuisines);
                    var _url1 = "https://cookify.stackroute.io:8443/userLogin/user";
                    return this.http.post(_url1, obj);
                };
                // localhost
                FrontendserviceService.prototype.postPublishRecipe = function (obj) {
                    var httpOptions = this.makeToken('token');
                    var urlz = "https://cookify.stackroute.io:8443/recipeService/api/v1/recipe";
                    return this.http.post(urlz, obj, httpOptions);
                };
                FrontendserviceService.prototype.getRecipeDetails = function (id) {
                    return this.http.get("https://cookify.stackroute.io:8443/recipeService/api/v1/recipedetail/" + id);
                };
                FrontendserviceService.prototype.getUserDetails = function (username) {
                    var httpOptions = this.makeToken('token');
                ...
                FrontendserviceService.prototype.SearchRecipe = function (reqname) {
                    var _url = "https://cookify.stackroute.io:8443/recipeService/api/v1/recipes/" + reqname;
                    return this.http.get(_url);
                };
                FrontendserviceService.prototype.saveuserlikerecipe = function (recipeobj) {
                    var httpOptions = this.makeToken('token');
                    var urlz = "https://cookify.stackroute.io:8443/userProfile/api/v1/userlikerecipe/" + localStorage.getItem('username');
                    console.log(urlz, "inside save");
                    return this.http.post(urlz, recipeobj, httpOptions);
                };
                FrontendserviceService.prototype.saveusertryrecipe = function (recipeobj) {
                    var httpOptions = this.makeToken('token');
                    var urlz = "https://cookify.stackroute.io:8443/userProfile/api/v1/usertryrecipe/" + localStorage.getItem('username');
                    console.log(urlz, "inside save");
                    return this.http.post(urlz, recipeobj, httpOptions);
                };
                FrontendserviceService.prototype.makeToken = function (token) {
                ...
                FrontendserviceService.prototype.getAddresses = function () {
                    var httpOptions = this.makeToken('token');
                ...
                FrontendserviceService.prototype.addFirstAddress = function (address) {
                    var httpOptions = this.makeToken('token');
                    var url = "https://cookify.stackroute.io:8443/deliveryService/api/v1/ds";
                    return this.http.post(url, address, httpOptions);
                };
                //to post address
                FrontendserviceService.prototype.addAddress = function (address) {
                    console.log(address);
                    var httpOptions = this.makeToken('token');
                ...
                FrontendserviceService.prototype.move = function (array) {
                    this.ordered = array;
                    console.log(this.ordered);
                    console.log("In move function");
                };
                FrontendserviceService.prototype.getarray = function () {
                    console.log(this.ordered);
                    console.log("In ordered Function");
                    return this.ordered;
                };
                FrontendserviceService.prototype.rating = function (recipedetail) {
                    var httpOptions = this.makeToken('token');
                    var _url = "https://cookify.stackroute.io:8443/recipeService/api/v1/recipe";
                    console.log("working");
                ...
                FrontendserviceService.prototype.addOrderDetails = function (orderDetails) {
                ...
                FrontendserviceService.prototype.getDeliveryGuy = function () {
                ...
                FrontendserviceService.prototype.getDistanceTime = function (userCoordinates, deliveryGuyCoordinates) {
                    //user location
                    ...
                    for (var _i = 0, deliveryGuyCoordinates_1 = deliveryGuyCoordinates; _i < deliveryGuyCoordinates_1.length; _i++) {
                        var val = deliveryGuyCoordinates_1[_i];
                    ...
                    var bingUrl = "https://dev.virtualearth.net/REST/v1/Routes/DistanceMatrix?origins=" + userLocation + "&destinations=" + deliveryGuyLocations + "&travelMode=driving&key=" + this.apiKey;
                    console.log(bingUrl);
                    return this.http.get(bingUrl);
                };
                //to get orderId
                FrontendserviceService.prototype.getOrderId = function () {
                    var httpOptions = this.makeToken('token');
                ...
                FrontendserviceService.prototype.deliveryGuysList = function (deliveryGuyList) {
                ...
                FrontendserviceService.prototype.getRegionalName = function (view) {
                    var httpOptions = this.makeToken('token');
                ...
                FrontendserviceService.prototype.getIngredients = function (recipeid) {
                ...
                FrontendserviceService.prototype.getCommonlyUsedIngredients = function () {
                    var httpOptions = this.makeToken('token');
                ...
                FrontendserviceService.prototype.updateImage = function (newUser) {
                    var httpOptions = this.makeToken('token');
                    return this.http.put("https://cookify.stackroute.io:8443/userProfile/api/v1/user/", newUser, httpOptions);
                };
                return FrontendserviceService;
            }());
            FrontendserviceService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HomecomponentComponent = /** @class */ (function () {
                function HomecomponentComponent(router) {
                    this.router = router;
                }
                HomecomponentComponent.prototype.fn = function (name) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LatestComponent = /** @class */ (function () {
                function LatestComponent(http, fservice) {
                    this.http = http;
                    this.fservice = fservice;
                    this.recipe = [];
                }
                LatestComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.fservice.getalllatestrecipe().subscribe(function (data) {
                        _this.recipe = data;
                        for (var i in Object.keys(_this.recipe)) {
                            if (_this.recipe[i].recipeImage == null) {
                                _this.recipe[i].recipeImage = "https://www.washingtonian.com/wp-content/uploads/2019/06/unnamed-1-2048x1365.jpg";
                            }
                        }
                        console.log(_this.recipe, "data of latest recipe");
                    });
                };
                return LatestComponent;
            }());
            LatestComponent.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _frontendservice_service__WEBPACK_IMPORTED_MODULE_3__["FrontendserviceService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoggednavbarComponent = /** @class */ (function () {
                function LoggednavbarComponent(iconRegistry, sanitizer, service, route) {
                    this.service = service;
                    this.route = route;
                    this.user = [];
                    iconRegistry.addSvgIcon('thumbs-up', sanitizer.bypassSecurityTrustResourceUrl('assets/img/examples/thumbup-icon.svg'));
                }
                LoggednavbarComponent.prototype.fn = function (name) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(router, http, FrontEndService, spinner) {
                    this.router = router;
                    this.http = http;
                ...
                LoginComponent.prototype.submitlogindetails = function (username, password) {
                    var _this = this;
                    this.spinner.show();
                    this.user.username = username;
                    this.user.password = password;
                    this.FrontEndService.login(this.user).subscribe(function (res) {
                        if (res.status == 200) {
                            var token = JSON.stringify(res.body);
                            var tokenPart = token.slice(10, -2);
                            localStorage.setItem('token', tokenPart);
                            localStorage.setItem('username', username);
                            _this.FrontEndService.getUserDetails(username).subscribe(function (data) { return localStorage.setItem('name', data.name); });
                        ...
                        if (error.status == 401)
                            _this.spinner.hide();
                        _this.loginstatus = "Incorrect Details";
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MasterComponent = /** @class */ (function () {
                function MasterComponent(http, fservice) {
                    this.http = http;
                    this.fservice = fservice;
                    this.masterdata = [];
                }
                MasterComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.fservice.getalltopmasters().subscribe(function (data) { _this.masterdata = data; console.log(_this.masterdata, "in master"); });
                };
                MasterComponent.prototype.masterid = function (id) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var MastercardComponent = /** @class */ (function () {
                function MastercardComponent() {
                    this.cu = [];
                }
                MastercardComponent.prototype.ngOnInit = function () {
                };
                MastercardComponent.prototype.master = function (id) {
                    console.log("clicked on master with id:" + id);
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PopularComponent = /** @class */ (function () {
                function PopularComponent(http, fservice) {
                    this.http = http;
                    this.fservice = fservice;
                    this.recipe = [];
                }
                PopularComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.fservice.getallpopularrecipe().subscribe(function (data) {
                        _this.recipe = data;
                        for (var i in Object.keys(_this.recipe)) {
                            if (_this.recipe[i].recipeImage == null) {
                                _this.recipe[i].recipeImage = "https://www.washingtonian.com/wp-content/uploads/2019/06/unnamed-1-2048x1365.jpg";
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _frontendservice_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../frontendservice.service */ "./src/app/frontendservice.service.ts");
            var PossibleRecipesCardsComponent = /** @class */ (function () {
                function PossibleRecipesCardsComponent(frontendservice) {
                    this.frontendservice = frontendservice;
                    this.ingredients = [];
                    this.recipe = [];
                }
                PossibleRecipesCardsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ...
                    console.log(list);
                    this.frontendservice.getallrecommendedrecipeByIngredients(list).subscribe(function (data) { _this.recipe = data; console.log(data); });
                };
                PossibleRecipesCardsComponent.prototype.getRecipes = function (list) {
                };
                return PossibleRecipesCardsComponent;
            }());
            PossibleRecipesCardsComponent.ctorParameters = function () { return [
                { type: _frontendservice_service__WEBPACK_IMPORTED_MODULE_2__["FrontendserviceService"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PossiblerecipesComponent = /** @class */ (function () {
                function PossiblerecipesComponent(fservice, router, route) {
                    var _this = this;
                    this.fservice = fservice;
                    this.router = router;
                    this.route = route;
                    ...
                    this.recipe = [];
                    this.filteredIngredients = this.ingredientCtrl.valueChanges.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["startWith"])(null), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (ingredient) { return ingredient ? _this.filter(ingredient) : _this.allIngredients.slice(); }));
                    this.name = localStorage.getItem('name');
                }
                PossiblerecipesComponent.prototype.remove = function (ingredient) {
                ...
                PossiblerecipesComponent.prototype.filter = function (name) {
                    return this.allIngredients.filter(function (ingredient) { return ingredient.toLowerCase().indexOf(name.toLowerCase()) === 0; });
                };
                PossiblerecipesComponent.prototype.selected = function (event) {
                    this.ingredients.push(event.option.viewValue);
                    this.ingredientInput.nativeElement.value = '';
                    this.ingredientCtrl.setValue(null);
                };
                PossiblerecipesComponent.prototype.showPossibleRecipes = function () {
                    var _this = this;
                    var list = '';
                    for (var i = 0; i < this.ingredients.length; i++) {
                        list += '_' + this.ingredients[i];
                    ...
                    console.log(list);
                    this.fservice.getallrecommendedrecipeByIngredients(list).subscribe(function (data) { _this.recipe = data; console.log(_this.recipe); });
                };
                PossiblerecipesComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var username = localStorage.getItem('username');
                    if (username == null) {
                        this.router.navigateByUrl('/login');
                    }
                    this.fservice.getCommonlyUsedIngredients().subscribe(function (data) {
                        console.log(data);
                        _this.commonlyUsedIngredients = data;
                    });
                };
                PossiblerecipesComponent.prototype.addToform = function (ingredient) {
                    console.log(ingredient);
                    this.ingredients.push(ingredient);
                    var index = this.commonlyUsedIngredients.indexOf(ingredient);
                    if (index >= 0) {
                        this.commonlyUsedIngredients.splice(index, 1);
                    }
                };
                PossiblerecipesComponent.prototype.tr = function (id) {
                    this.router.navigateByUrl("/recipedetails/" + id);
                };
                return PossiblerecipesComponent;
            }());
            PossiblerecipesComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            //   process: Process[];
            // }
            var PublishRecipeComponent = /** @class */ (function () {
                function PublishRecipeComponent(route, _formBuilder, http, fservice) {
                    this.route = route;
                ...
                PublishRecipeComponent.prototype.createstage = function () {
                    var newstage = { id: this.i + 1, stagevalue: false, name: name, steps: [] };
                    this.stages.push(newstage);
                    this.i++;
                };
                PublishRecipeComponent.prototype.createstep = function (stage) {
                    var _this = this;
                    this.stages.forEach(function (element) {
                        if (element.id == stage.id) {
                            ...
                            _this.stages[element.id] = element;
                        }
                    });
                };
                PublishRecipeComponent.prototype.save = function (stagevalue, durationvalue, stageview) {
                ...
                PublishRecipeComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.filteredOptions = this.myControl.valueChanges
                        .pipe(Object(rxjs_internal_operators_startWith__WEBPACK_IMPORTED_MODULE_7__["startWith"])(''), Object(rxjs_internal_operators_map__WEBPACK_IMPORTED_MODULE_8__["map"])(function (value) { return _this._filter(value); }));
                    this.filteredOptions1 = this.myControl1.valueChanges
                        .pipe(Object(rxjs_internal_operators_startWith__WEBPACK_IMPORTED_MODULE_7__["startWith"])(''), Object(rxjs_internal_operators_map__WEBPACK_IMPORTED_MODULE_8__["map"])(function (value1) { return _this._filter1(value1); }));
                    this.filteredIngredients = this.ingredientCtrl.valueChanges
                        .pipe(Object(rxjs_internal_operators_startWith__WEBPACK_IMPORTED_MODULE_7__["startWith"])(''), Object(rxjs_internal_operators_map__WEBPACK_IMPORTED_MODULE_8__["map"])(function (value2) { return _this._filter2(value2); }));
                    this.username = localStorage.getItem('username');
                    this.jwtToken = localStorage.getItem('token');
                    this.name = localStorage.getItem('name');
                    if (this.username == null) {
                ...
                PublishRecipeComponent.prototype._filter = function (value) {
                    var filterValue = value.toLowerCase();
                    return this.options.filter(function (option) { return option.toLowerCase().includes(filterValue); });
                };
                PublishRecipeComponent.prototype._filter1 = function (value1) {
                    var filterValue1 = value1.toLowerCase();
                    return this.options1.filter(function (option1) { return option1.toLowerCase().includes(filterValue1); });
                };
                PublishRecipeComponent.prototype._filter2 = function (value2) {
                    var filterValue2 = value2.toLowerCase();
                    return this.options3.filter(function (option2) { return option2.toLowerCase().includes(filterValue2); });
                };
                PublishRecipeComponent.prototype.onFileComplete = function (data) {
                    console.log(data); // We just print out data bubbled up from event emitter.
                    this.urll = data;
                    this.stageimageview = false;
                };
                PublishRecipeComponent.prototype.onFileComplete1 = function (data) {
                    console.log(data); // We just print out data bubbled up from event emitter.
                    this.urll1 = data;
                    this.imageview = false;
                };
                PublishRecipeComponent.prototype.onFileComplete2 = function (data) {
                    console.log(data); // We just print out data bubbled up from event emitter.
                    this.urll2 = data.body;
                };
                PublishRecipeComponent.prototype.onFileComplete3 = function (data) {
                    console.log(data); // We just print out data bubbled up from event emitter.
                    this.urll3 = data.body;
                };
                PublishRecipeComponent.prototype.onFileComplete4 = function (data) {
                    console.log(data); // We just print out data bubbled up from event emitter.
                    this.urll4 = data.body;
                };
                PublishRecipeComponent.prototype.add = function (event) {
                ...
                PublishRecipeComponent.prototype.remove = function (ingredients) {
                    console.log(this.ingredients);
                    console.log(ingredients);
                    var index = this.ingredients.indexOf(ingredients);
                    console.log(index);
                ...
                PublishRecipeComponent.prototype.addLink = function () {
                    this.links.push("Step " + (this.links.length + 1));
                };
                PublishRecipeComponent.prototype.addLink1 = function () {
                    console.log(this.links1);
                    this.links1.push("Step " + (this.links1.length + 1));
                    console.log(this.links1);
                };
                PublishRecipeComponent.prototype.addLink2 = function () {
                    this.links2.push("Step " + (this.links2.length + 1));
                };
                PublishRecipeComponent.prototype.addLink3 = function () {
                    this.links3.push("Step " + (this.links3.length + 1));
                };
                PublishRecipeComponent.prototype.addLink4 = function () {
                    this.links4.push("Step " + (this.links4.length + 1));
                };
                PublishRecipeComponent.prototype.addProcess = function (value) {
                    console.log(value);
                    this.step.push({ stepContent: value });
                    console.log(this.step);
                };
                PublishRecipeComponent.prototype.addProcess1 = function (value) {
                    this.step1.push({ stepContent: value });
                    console.log(this.step1);
                };
                PublishRecipeComponent.prototype.addProcess2 = function (value) {
                    this.step2.push({ stepContent: value });
                };
                PublishRecipeComponent.prototype.addProcess3 = function (value) {
                    this.step3.push({ stepContent: value });
                };
                PublishRecipeComponent.prototype.addProcess4 = function (value) {
                    this.step4.push({ stepContent: value });
                };
                PublishRecipeComponent.prototype.adda = function () {
                    this.a++;
                };
                PublishRecipeComponent.prototype.adda1 = function () {
                    this.a1++;
                };
                PublishRecipeComponent.prototype.adda2 = function () {
                    this.a2++;
                };
                PublishRecipeComponent.prototype.adda3 = function () {
                    this.a3++;
                };
                PublishRecipeComponent.prototype.adda4 = function () {
                    this.a4++;
                };
                PublishRecipeComponent.prototype.addStages = function (value, value1) {
                    this.stage.push({ stageName: value, duration: value1, steps: this.step, images: this.urll });
                    console.log(this.stage);
                };
                PublishRecipeComponent.prototype.addStages1 = function (value, value1) {
                    this.stage.push({ stageName: value, duration: value1, steps: this.step1, images: this.urll1 });
                    console.log(this.stage);
                };
                PublishRecipeComponent.prototype.addStages2 = function (value, value1) {
                    this.stage.push({ stageName: value, duration: value1, steps: this.step2, images: this.urll2 });
                };
                PublishRecipeComponent.prototype.addStages3 = function (value, value1) {
                    this.stage.push({ stageName: value, duration: value1, steps: this.step3, images: this.urll3 });
                };
                PublishRecipeComponent.prototype.addStages4 = function (value, value1) {
                    this.stage.push({ stageName: value, duration: value1, steps: this.step4, images: this.urll4 });
                };
                PublishRecipeComponent.prototype.addIngredient = function (value1, value2) {
                    var n = this.ingredients.length;
                ...
                PublishRecipeComponent.prototype.enableDisableRule = function () {
                    this.toggle = !this.toggle;
                    this.status = this.toggle ? 'Confirm Ingredients' : 'Ingredients Confirmed';
                };
                PublishRecipeComponent.prototype.enableDisableRule1 = function (job) {
                    this.toggle1 = !this.toggle1;
                    this.status1 = this.toggle1 ? 'Confirm Step' : 'Step Confirmed';
                };
                PublishRecipeComponent.prototype.cookingTime = function (procedure) {
                    var x;
                    x = 0;
                    for (var _i = 0, _a = procedure.stages; _i < _a.length; _i++) {
                        var v = _a[_i];
                        x = x + Number(v.duration);
                    }
                    return x;
                };
                PublishRecipeComponent.prototype.capital_letter = function (str) {
                    var strs;
                    strs = str.split(" ");
                ...
                PublishRecipeComponent.prototype.publishRecipe = function (value1, value2, value3, value4, value5) {
                    //  this.procedure=({stages:this.stage});
                    console.log("In publish recipe");
                    var recipe = ({ recipeName: this.capital_letter(value1),
                        description: value2,
                        cuisine: value3,
                ...
                PublishRecipeComponent.prototype.addn = function () {
                    if (this.n == 5) {
                    }
                    else {
                        this.n++;
                ...
                PublishRecipeComponent.prototype.addToform = function (ingredient) {
                    console.log(ingredient);
                    this.ingredients.push({ category: "tom",
                        name: ingredient.trim(),
                        quantity: 0,
                        unit: "tbs" });
                    var index = this.suggestedIngredients.indexOf(ingredient);
                    if (index >= 0) {
                        this.suggestedIngredients.splice(index, 1);
                    }
                };
                PublishRecipeComponent.prototype.getsuggestedIngredients = function (value1, value2, value3) {
                    var _this = this;
                    var value = value1 + "_" + value2 + "_" + value3;
                    this.fservice.getSuggestedIngredients(value).subscribe(function (data) {
                        console.log(data);
                        _this.suggestedIngredients = data;
                    });
                };
                PublishRecipeComponent.prototype.selected = function (event) {
                    var newIngredient = { category: "tom",
                ...
                return PublishRecipeComponent;
            }());
            PublishRecipeComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_6__["Router"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RatingComponent = /** @class */ (function () {
                function RatingComponent(dialogRef, data, route, fservice, http) {
                ...
                RatingComponent.prototype.onNoClick = function () {
                    this.dialogRef.close();
                };
                RatingComponent.prototype.onClick = function (i, y) {
                    var _this = this;
                    this.data.rating = i;
                    ...
                    this.fservice.getRecipeDetails(this.data.recipeId).subscribe(function (data1) {
                        var rat = { "username": localStorage.getItem('username'), "rating": _this.data.rating, "time": null };
                        for (i = 0; i < data1.ratings.length; i++) {
                            var rat1 = data1.ratings[i];
                        ...
                        var com = { "username": localStorage.getItem('username'), "comment": _this.data.comments, "time": null, "userImage": null };
                        for (i = 0; i < data1.comments.length; i++) {
                            var com1 = data1.comments[i];
                        ...
                        _this.recipedetail = data1;
                        console.log(_this.recipedetail, "recipedetails");
                        _this.fservice.rating(_this.recipedetail).subscribe();
                    });
                    this.fservice.getRecipeDetails(this.data.recipeId).subscribe(function (data2) { _this.Finaldetail = data2; console.log(_this.Finaldetail, "Finalrecipedetails"); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RecipecardComponent = /** @class */ (function () {
                function RecipecardComponent(router) {
                    this.router = router;
                }
                ...
                RecipecardComponent.prototype.tr = function (id) {
                    this.router.navigateByUrl("/recipedetails/" + id);
                };
                return RecipecardComponent;
            }());
            RecipecardComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
            tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
                Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DetailService = /** @class */ (function () {
                ...
                DetailService.prototype.getrecipedetails = function () {
                    return this.http.get(this._url);
                };
                DetailService.prototype.getrecing = function () {
                    return this.http.get(this._url1);
                };
                DetailService.prototype.getproce = function () {
                    return this.http.get(this._url2);
                };
                return DetailService;
            }());
            DetailService.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RecipedetailsComponent = /** @class */ (function () {
                function RecipedetailsComponent(search1, route, router, http, fservice) {
                ...
                RecipedetailsComponent.prototype.ngOnInit = function () {
                    ...
                    this.fservice.getNumberOfTriedInRecipe(this.recipeid).subscribe(function (data) { return _this.viewcount = data; });
                    this.fservice.getRecipeDetails(this.recipeid).subscribe(function (data) {
                        _this.recipedetail = data;
                        console.log(data, "recipedetails");
                        _this.duration = data.procedure.stages;
                        console.log(_this.duration);
                        for (var i = 0; i < _this.duration.length; i++) {
                            var totalduration = _this.duration[i].duration;
                            console.log(totalduration);
                            _this.init = _this.init + totalduration;
                            console.log(_this.init);
                        }
                        data.cookingTime = _this.init;
                        console.log(data.cookingTime);
                        console.log(_this.commentsArray);
                        console.log(_this.viewcomments, "in RECIPEDETAILS");
                        var j = 0;
                        for (var i = 0; i < _this.commentsArray.length; i++) {
                            if ((_this.commentsArray[i].comment) != "") {
                                _this.viewcomments[j] = _this.commentsArray[i];
                                j++;
                            }
                        }
                        ;
                    ...
                    console.log("hhhhh");
                    this.fservice.getIngredients(this.recipeid).subscribe(function (data) {
                        console.log(data);
                        _this.ingredients = data;
                    });
                    this.fservice.getNumberOfTried(this.recipeid).subscribe(function (data) { console.log(data); });
                };
                RecipedetailsComponent.prototype.navtopage = function (id) {
                ...
                RecipedetailsComponent.prototype.regionalName = function (view) {
                    this.ing = view;
                };
                RecipedetailsComponent.prototype.viewname = function (name) {
                    if (this.ing == name) {
                        return true;
                    }
                    else {
                ...
                RecipedetailsComponent.prototype.removeRegionalName = function () {
                    this.ing = "";
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var _frontendservice_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../frontendservice.service */ "./src/app/frontendservice.service.ts");
            var RecommededComponent = /** @class */ (function () {
                function RecommededComponent(http, fservice) {
                    this.http = http;
                    this.fservice = fservice;
                    this.recipe = [];
                    this.image = "https://media.gettyimages.com/photos/authentic-indian-food-picture-id639389404?s=612x612";
                }
                RecommededComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.name = localStorage.getItem('name');
                    this.fservice.getallrecommendedrecipe().subscribe(function (data) {
                        _this.recipe = data;
                        for (var i in Object.keys(_this.recipe)) {
                            if (_this.recipe[i].recipeImage == null) {
                                _this.recipe[i].recipeImage = "https://www.washingtonian.com/wp-content/uploads/2019/06/unnamed-1-2048x1365.jpg";
                        ...
                        console.log(_this.recipe, "data of trending recipe");
                    });
                };
                return RecommededComponent;
            }());
            RecommededComponent.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _frontendservice_service__WEBPACK_IMPORTED_MODULE_3__["FrontendserviceService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var _frontendservice_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../frontendservice.service */ "./src/app/frontendservice.service.ts");
            var RecommendedbyactivitiesComponent = /** @class */ (function () {
                function RecommendedbyactivitiesComponent(http, fservice) {
                    this.http = http;
                    this.fservice = fservice;
                    this.recipe = [];
                    this.image = "https://media.gettyimages.com/photos/authentic-indian-food-picture-id639389404?s=612x612";
                }
                RecommendedbyactivitiesComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.fservice.getallrecommendedbyhistoryrecipe().subscribe(function (data) {
                        _this.recipe = data;
                        for (var i in Object.keys(_this.recipe)) {
                            if (_this.recipe[i].recipeImage == null) {
                                _this.recipe[i].recipeImage = "https://www.washingtonian.com/wp-content/uploads/2019/06/unnamed-1-2048x1365.jpg";
                ...
                return RecommendedbyactivitiesComponent;
            }());
            RecommendedbyactivitiesComponent.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _frontendservice_service__WEBPACK_IMPORTED_MODULE_3__["FrontendserviceService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm2015/http.js");
            /* harmony import */ var _frontendservice_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../frontendservice.service */ "./src/app/frontendservice.service.ts");
            var RecommendedbyhistoryComponent = /** @class */ (function () {
                function RecommendedbyhistoryComponent(http, fservice) {
                    this.http = http;
                    this.fservice = fservice;
                    this.recipe = [];
                }
                RecommendedbyhistoryComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.fservice.getallrecommendedbyhistoryrecipe().subscribe(function (data) { console.log(data); _this.recipe = data; console.log(_this.recipe, "data of trending recipe"); });
                };
                RecommendedbyhistoryComponent.prototype.tr = function (id) {
                    console.log("clicked on trending recipe id:" + id);
                };
                return RecommendedbyhistoryComponent;
            }());
            RecommendedbyhistoryComponent.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _frontendservice_service__WEBPACK_IMPORTED_MODULE_3__["FrontendserviceService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RegisterComponent = /** @class */ (function () {
                function RegisterComponent(frontendserviceservice, http, router) {
                ...
                RegisterComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.filteredOptions1 = this.myControl1.valueChanges
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["startWith"])(''), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["map"])(function (value1) { return _this._filter1(value1); }));
                };
                RegisterComponent.prototype._filter1 = function (value1) {
                    var filterValue1 = value1.toLowerCase();
                    return this.options1.filter(function (option1) { return option1.toLowerCase().includes(filterValue1); });
                };
                RegisterComponent.prototype.getStateAndCountry = function ($event, city) {
                    var _this = this;
                    this.frontendserviceservice.getStateAndCountry().subscribe(function (data) {
                        console.log(data);
                        for (var i in Object.keys(data)) {
                            var s = data[i].City;
                            if (s == city) {
                                _this.state = data[i].State;
                                _this.country = "India";
                                break;
                            }
                        }
                ...
                RegisterComponent.prototype.registerUser = function (name, st, email, userName, password, city, age, gender, ct) {
                    var _this = this;
                    ...
                    this.frontendserviceservice.userRegister(userObj).subscribe(function (data) {
                        console.log(data.id + "antara");
                        _this.userId = data.id;
                        _this.router.navigate(['/selectyourinterests', data.id]);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SearchComponentComponent = /** @class */ (function () {
                function SearchComponentComponent(searchRecipe, route, http, router) {
                    this.searchRecipe = searchRecipe;
                    this.route = route;
                    this.http = http;
                    this.router = router;
                }
                SearchComponentComponent.prototype.tr = function (id) {
                ...
                SearchComponentComponent.prototype.ngOnInit = function () {
                    ...
                    console.log(name);
                    this.searchRecipe.SearchRecipe(name).subscribe(function (data) { _this.searchResult = data; console.log(data, "searchresults"); });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _frontendservice_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../frontendservice.service */ "./src/app/frontendservice.service.ts");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var SelectinterestsComponent = /** @class */ (function () {
                function SelectinterestsComponent(formBuilder, search1, router, activateroute) {
                ...
                SelectinterestsComponent.prototype.addfinal = function () {
                    for (var i in Object.keys(this.recipeform.value.favourites)) {
                        var favCuisine = this.recipeform.value.favourites[i];
                    ...
                    this.search1.submitfinalfavourites(newUser).subscribe(function (res) { return console.log(res); });
                    this.router.navigateByUrl("/login");
                };
                SelectinterestsComponent.prototype.onChange = function (view, isChecked) {
                    var control = this.recipeform.controls.favourites;
                    if (isChecked) {
                        ...
                        var index = control.controls.findIndex(function (x) { return (x.value == view); });
                        console.log(view);
                        control.removeAt(index);
                        console.log(index);
                    }
                };
                SelectinterestsComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    var data = this.activateroute.snapshot.paramMap.get('data');
                    console.log(data + "ssss");
                    this.search1.getUser(data).subscribe(function (res) { console.log(res); _this.user = res; });
                };
                return SelectinterestsComponent;
            }());
            SelectinterestsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TestcomponentComponent = /** @class */ (function () {
                ...
                TestcomponentComponent.prototype.findme = function () {
                    var _this = this;
                    if (navigator.geolocation) {
                        navigator.geolocation.getCurrentPosition(function (position) { _this.lat = position.coords.latitude; _this.lng = position.coords.longitude; console.log(position); });
                    }
                    else {
                        console.log("nothing");
                    }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TrendingComponent = /** @class */ (function () {
                function TrendingComponent(http, fservice) {
                    this.http = http;
                    this.fservice = fservice;
                    this.recipe = [];
                }
                TrendingComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.fservice.getalltrendingrecipe().subscribe(function (data) {
                        _this.recipe = data;
                        for (var i in Object.keys(_this.recipe)) {
                            if (_this.recipe[i].recipeImage == null) {
                                _this.recipe[i].recipeImage = "https://www.washingtonian.com/wp-content/uploads/2019/06/unnamed-1-2048x1365.jpg";
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var OrderpreviewComponent = /** @class */ (function () {
                function OrderpreviewComponent(spinner, _formBuilder, frontendservice, http, route, activatedrouter) {
                    this.spinner = spinner;
                    this._formBuilder = _formBuilder;
                    this.frontendservice = frontendservice;
                    this.http = http;
                ...
                OrderpreviewComponent.prototype.ngOnInit = function () {
                    ...
                    this.frontendservice.getAddresses().subscribe(function (data) {
                        console.log(data);
                        if (data == null) {
                            _this.isNewUser = true;
                        }
                        else {
                            _this.deliveryAddress = data;
                            _this.addresses = _this.deliveryAddress.addresses;
                            console.log(_this.addresses);
                        }
                    });
                };
                OrderpreviewComponent.prototype.saveAddress = function (addressName, name, mobile, address, city, state, pinCode) {
                    var _this = this;
                    ...
                    if (navigator.geolocation) {
                        navigator.geolocation.getCurrentPosition(function (position) {
                            ...
                            _this.userCoordinates = { "latitude": _this.latitude, "longitude": _this.longitude };
                            var addr = { "addressName": addressName, "name": name, "mobileNumber": mobile, "location": address, "city": city, "state": state, "pin": pinCode, "coordinates": _this.userCoordinates };
                            console.log(addr);
                            var addrArray = [];
                            addrArray.push(addr);
                            ...
                            if (_this.isNewUser) {
                                ...
                                console.log(newAddr);
                                _this.frontendservice.addFirstAddress(newAddr).subscribe(function (data) { return console.log(data); });
                            }
                            else {
                                _this.frontendservice.addAddress(addr).subscribe(function (data) { return console.log(data); });
                            }
                        });
                ...
                OrderpreviewComponent.prototype.cancelAddress = function () {
                    this.secondFormGroup.reset();
                };
                OrderpreviewComponent.prototype.navtopage = function (id) {
                    this.route.navigateByUrl("/tryrecipe/" + this.recipeid + "/" + id);
                };
                OrderpreviewComponent.prototype.fn = function () {
                    this.display = true;
                };
                OrderpreviewComponent.prototype.fns = function (i) {
                    console.log(i);
                };
                OrderpreviewComponent.prototype.submit = function (i) {
                    this.currentAddress = this.addresses[i];
                    console.log(this.addresses);
                    console.log(this.currentAddress);
                };
                OrderpreviewComponent.prototype.getbacktocooking = function () {
                    this.route.navigateByUrl("/tryrecipe/" + this.recipeid + "/1");
                };
                OrderpreviewComponent.prototype.onClick = function () {
                    var _this = this;
                    this.spinner.show();
                    ...
                    this.frontendservice.addOrderDetails(addressIngredients).subscribe(function (data) { return console.log(data); });
                    //to get coordinates of all the active delivery guys
                    this.frontendservice.getDeliveryGuy().subscribe(function (data) {
                        _this.deliveryGuyDetails = data;
                        console.log(data);
                        //to store delivery guys coordinates
                        for (var i = 0; i < _this.deliveryGuyDetails.length; i++) {
                            var x = { "latitude": _this.deliveryGuyDetails[i].coordinates.latitude, "longitude": _this.deliveryGuyDetails[i].coordinates.longitude };
                            _this.deliveryGuyCoordinates[i] = x;
                        }
                        _this.spinner.hide();
                        console.log(_this.deliveryGuyCoordinates);
                        ...
                        navigator.geolocation.getCurrentPosition(function (position) {
                            ...
                            _this.frontendservice.getDistanceTime(position.coords, _this.deliveryGuyCoordinates).subscribe(function (list) {
                                _this.distanceTime = list.resourceSets[0].resources[0].results;
                                for (var i = 0; i < _this.distanceTime.length; i++) {
                                    var x = { "deliveryUsername": _this.deliveryGuyDetails[i].deliveryUsername,
                                        "distance": _this.distanceTime[i].travelDistance,
                                        "time": _this.distanceTime[i].travelDuration };
                                    _this.deliveryGuyList[i] = x;
                                }
                                //var finalList={"username":localStorage.getItem("username"),"deliveryGuyDistanceTime":this.deliveryGuyList};
                                //console.log(finalList);
                                var finalList = { "orderId": localStorage.getItem("username"), "deliveryGuyDistanceTime": _this.deliveryGuyList };
                                ...
                                console.log(finalList);
                                _this.frontendservice.deliveryGuysList(finalList).subscribe(function (data) { return console.log(data); });
                                _this.recipentname = localStorage.getItem('name');
                                _this.frontendservice.getorderdetails().subscribe(function (data) { _this.od = data, console.log("barunbarunbarun", data); });
            ...
            OrderpreviewComponent.ctorParameters = function () { return [
                { type: ngx_spinner__WEBPACK_IMPORTED_MODULE_6__["NgxSpinnerService"] },
                { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
                { type: _frontendservice_service__WEBPACK_IMPORTED_MODULE_4__["FrontendserviceService"] },
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HttpClient"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TryrecipeComponent = /** @class */ (function () {
                function TryrecipeComponent(http, route, fservice, dialog, router) {
                    this.http = http;
                    this.route = route;
                    this.fservice = fservice;
                    this.dialog = dialog;
                ...
                TryrecipeComponent.prototype.ngOnInit = function () {
                    ...
                    this.fservice.getRecipeDetails(this.recipeid)
                        ...
                        _this.recipe = data;
                        console.log(_this.recipe, "Recipe Details");
                        _this.num = data.servesFor;
                        _this.onum = data.servesFor;
                        _this.numduplicate = data.servesFor;
                        _this.igLength = (data.ingredients).length;
                        _this.ing = data.ingredients;
                        _this.ingnames = data.ingredients.name;
                        _this.Procedure = data.procedure;
                        console.log(data.ingredients);
                        for (var i = 0; i < _this.ing.length; i++) {
                            _this.ingName[i] = _this.ing[i].name;
                            _this.ingQuantity[i] = _this.ing[i].quantity;
                        }
                        console.log(_this.ingName);
                        console.log(_this.ingQuantity);
                        for (var i = 0; i < data.procedure.stages.length; i++) {
                            _this.timeRem[i] = _this.Procedure.stages[i].duration;
                            _this.duration[i] = _this.Procedure.stages[i].duration;
                            _this.timePercent[i] = 0;
                            _this.head[i] = "normal";
                            if (i == 0)
                                _this.xpandStatus[i] = true;
                            else
                                _this.xpandStatus[i] = false;
                            //this.xpandNoClose[i] = false;
                            _this.showStart[i] = true;
                            _this.showPause[i] = false;
                            _this.showStop[i] = false;
                            _this.showRestart[i] = false;
                            _this.intervals[i];
                            var intro = "Hey, let's make" + data.recipeName + "! Have a wonderful cooking time. ";
                            var steps = ". This consists of, " + _this.Procedure.stages[i].steps.length + "steps. ";
                            if (i == 0) {
                                _this.speech[i] = intro + "Stage" + (i + 1) + '. ' + _this.Procedure.stages[i].stageName + steps;
                            }
                            else
                                _this.speech[i] = "Stage" + (i + 1) + ',' + _this.Procedure.stages[i].stageName + steps;
                        }
                    });
                    console.log(this.synthesis.speaking);
                };
                // Serve for count, pass it to backend
                TryrecipeComponent.prototype.changeserve = function (operation) {
                    if (operation == 'minus') {
                        if (this.num <= 0) {
                            this.num = 0;
                        }
                            ...
                            if (this.num == this.numduplicate) {
                                this.display = true;
                                this.display2 = false;
                                for (var i = 0; i < this.ingQuantity.length; i++) {
                ...
                TryrecipeComponent.prototype.orderval = function () {
                    var obj = [];
                    for (var i = 0; i < this.igLength; i++) {
                        var x;
                    ...
                    for (var i = obj.length, j = 0; i < (obj.length + this.fieldArray.length); i++, j++) {
                ...
                TryrecipeComponent.prototype.startTimer = function (i) {
                    var _this = this;
                    //Show timer controls
                    ...
                    this.intervals[i] = setInterval(function () {
                        if (_this.timeRem[i] > 0) {
                            _this.timeRem[i]--;
                            _this.timePercent[i] = ((_this.duration[i] - _this.timeRem[i]) * 100) / _this.duration[i];
                            _this.head[i] = "ongoing";
                            //Halfway through cooking
                            if (_this.timeRem[i] == (_this.duration[i]) / 2) {
                                var utterance = new SpeechSynthesisUtterance('Hello world');
                                utterance.text = "Hey, we are halfway through " + _this.Procedure.stages[i].stageName + ". Hope you are there.";
                                _this.synthesis.speak(utterance);
                            }
                            //Cooking about to end
                            if (_this.timeRem[i] == 30) {
                                var utterance = new SpeechSynthesisUtterance('Hello world');
                                utterance.text = "Hey, hope " + _this.Procedure.stages[i].stageName + " is almost done. ";
                                _this.synthesis.speak(utterance);
                                //Last stage
                                if (i == _this.Procedure.stages.length - 1) {
                                    ...
                                    _this.synthesis.speak(utterance1);
                                    _this.synthesis.speak(utterance2);
                                }
                                else {
                                    var utterance1 = new SpeechSynthesisUtterance();
                                    utterance1.text = "Our next stage is " + _this.Procedure.stages[i + 1].stageName;
                                    _this.synthesis.speak(utterance1);
                                }
                            }
                        }
                        //If timer is stopped
                            ...
                            _this.head[i] = "completed";
                            //Display only Restart
                            _this.timeRem[i] = 0;
                            _this.showRestart[i] = true;
                            _this.showStart[i] = false;
                            _this.showStop[i] = false;
                            _this.showPause[i] = false;
                        }
                    }, 1000);
                ...
                // Pause Timer
                TryrecipeComponent.prototype.pauseTimer = function (i) {
                ...
                //Stop Timer
                TryrecipeComponent.prototype.stopTimer = function (i) {
                ...
                //Restart Timer
                TryrecipeComponent.prototype.restartTimer = function (i) {
                    this.showStart[i] = false;
                    this.showPause[i] = true;
                    this.showStop[i] = true;
                    this.showRestart[i] = false;
                ...
                TryrecipeComponent.prototype.openDialog = function () {
                    var _this = this;
                    var dialogRef = this.dialog.open(_rating_rating_component__WEBPACK_IMPORTED_MODULE_5__["RatingComponent"], {
                        width: '30%', height: '50%',
                ...
                //pass it to backend
                TryrecipeComponent.prototype.addFieldValue = function () {
                    this.add = this.add + 1;
                ...
                TryrecipeComponent.prototype.deleteRow = function (id) {
                    this.fieldArray.splice(id, 1);
                };
                TryrecipeComponent.prototype.checkNumber = function (num) {
                    if (this.num % 2 == 0) {
                        this.isEven = true;
                    }
                ...
                TryrecipeComponent.prototype.changeUnits = function () {
                };
                return TryrecipeComponent;
            }());
            TryrecipeComponent.ctorParameters = function () { return [
                { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"] },
                { type: _frontendservice_service__WEBPACK_IMPORTED_MODULE_3__["FrontendserviceService"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserprofileComponent = /** @class */ (function () {
                ...
                UserprofileComponent.prototype.ngOnInit = function () {
                    ...
                    var username = localStorage.getItem('username');
                    this.name = localStorage.getItem('name');
                    this.service.getUserDetails(username).subscribe(function (data) {
                        console.log(data);
                        _this.user = data;
                        console.log(_this.user.username + _this.user.name);
                        if (_this.user.image == null) {
                            _this.user.image = "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_640.png";
                        }
                        _this.recipespublished = data.recipesPublished;
                        _this.recipestried = data.recipesTried;
                        _this.recipesliked = data.recipesLiked;
                    });
                    // delay(10000);
                    console.log("shshshh");
                    console.log(this.user + "hello");
                };
                UserprofileComponent.prototype.onFileComplete = function (data) {
                    console.log(data); // We just print out data bubbled up from event emitter.
                ...
                UserprofileComponent.prototype.getUrl = function () {
                    var url = "url('" + this.user.image + "')";
                    console.log(url + "hhdj");
                    return url;
                };
                UserprofileComponent.prototype.approve = function () {
                    var newUser = this.user;
                    this.service.updateImage(newUser).subscribe(function (data) { return console.log(data); });
                    this.upload = true;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var VoicetestComponent = /** @class */ (function () {
                function VoicetestComponent() {
                }
                VoicetestComponent.prototype.ngOnInit = function () {
                };
